...
public class EditRecipeControler implements Serializable {
     ...
     * @return 
     * 
     * Trasformamos la imagen en stramContent y se la pasamos al p:grafricImage de la vista
     */
     ...
     * @param ing 
     * 
     * Borramos lso ingredientes de la receta
     */
     ...
     * @return 
     * 
     * Obtenemos los ingredientes de la receta para imprimirlos en la vista
     */
    ...
    /**
     * 
     * Metemos un nuevo ingrediente en la lista de ingredientes de la receta
     */
    ...
    /**
     * 
     * Seteamos el nuevo orden de los pasos de la receta
     */
     ...
     * @param step 
     * 
     * Borramos el paso que pasamos por parametro
     */
    ...
    /**
     * 
     * Ordenamos los pasos despues de haber borrado algun paso
     */
     ...
     * @return 
     * 
     * Insertamos un nuevo paso en la receta
     */
    ...
    /**
     * Clase auxialiar para imprimir los ingredientes
     */

...
public class Email {
	...
	public void send() throws IOException {
		...
		// remitente también.
		String remitente = "cocinalotodoemail"; // Para la dirección nomcuenta@gmail.com
                System.out.println("ghggg");

                /*
		InputStream is = getClass().getResourceAsStream("./resources/data/password.txt"); // lee el fichero txt de contraseñas
		...
		props.put("mail.smtp.clave", "patata1234"); // La clave de la cuenta
		...
		try {
			...
			transport.connect("smtp.gmail.com", remitente, "patata1234");
